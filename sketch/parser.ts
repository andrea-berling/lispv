...
import { number, grammar, expression, space, spaces, optional_spaces, lbracket, rbracket, one_or_more_expressions, operation } from "../src/grammar/definitions"
...
if (result.parsed) {
	...
	let ast = be.remove(spaces, lbracket, rbracket, optional_spaces);
